...
namespace System
{
    ...
    struct Enum
    {
        ...
        /// @param str String that is interpreted as containing the name of enum constant
        /// @param result The output parameter that if conversion succeeds contains the result of conversion on function
    ...
    protected:
        ...
        /// Returns an array containing all names of enumeration @p E.
        ...
        /// @param val The value of the enum constant
        /// @returns A boxed value of the enum constant whose vakye is specified in @p str.
    ...
    public:
        ...
        /// @return A string array of the names of the constants in enumType.
        ...
        /// @param str The name of the enum constant
        /// @param ignoreCase Specifeis if the case should be ignored when interpreting the name of the enum constant
        /// @return An object that represents the value of the enum constant whose name is specified in @p str.
        ...
        /// @param type The enumeration type to return.
        /// @param value The value to convert to an enumeration member.
        /// @return An instance of the enumeration set to value.
        static ASPOSECPP_SHARED_API SharedPtr<Object> ToObject(const TypeInfo& type, uint64_t value);
        /// Converts the specified object with an integer value to an enumeration member.
        /// @param type The enumeration type to return.
        /// @param value The value convert to an enumeration member.
        /// @return An enumeration object whose value is value.
        static ASPOSECPP_SHARED_API SharedPtr<Object> ToObject(const TypeInfo& type, const SharedPtr<Object>& value);
        /// Returns the underlying type of the specified enumeration.
        /// @param type The enumeration whose underlying type will be retrieved.
        /// @return The underlying type of enumType.
