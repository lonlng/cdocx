...
class ASPOSECPP_SHARED_CLASS BaseKVCollection : public IKVCollection<KV>
{
public:
    /// Creates collection.
    ...
    void SetTemplateWeakPtr(uint32_t argument) override
    {
        ...
        CODEPORTING_DEBUG_ASSERT(!"BaseKVCollection doesn't own data structures so it can't be used to store Weak pointers");
    }
