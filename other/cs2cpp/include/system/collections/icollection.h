...
/// @param T Stored type.
template<typename T>
class ASPOSECPP_SHARED_CLASS ICollection : public virtual System::Collections::Generic::IEnumerable<T>
{
    /// RTTI information.
    RTTI_INFO_TEMPLATE_CLASS(System::Collections::Generic::ICollection<T>, System::BaseTypesInfo<System::Collections::Generic::IEnumerable<T>>);
...
public:
    ...
    ICollection& operator = (ICollection&&) noexcept { return *this; }
    /// Move assignment operator.
    /// @return Reference to this.
    ...
    SharedPtr<Object> get_SyncRoot() const { return const_cast<ThisType*>(this); }
};
