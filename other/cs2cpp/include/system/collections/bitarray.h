...
public:
    ...
    ASPOSECPP_SHARED_API BitArray(const BitArrayPtr& array);
    /// Copy constructor.
    ...
    ASPOSECPP_SHARED_API BitArrayPtr And(const BitArrayPtr& value);
    /// Calculates bitwise 'or' between two BitSets.
    /// @param value RHS operand.
    /// @return Bitwise 'or' result.
    ASPOSECPP_SHARED_API BitArrayPtr Or(const BitArrayPtr& value);
    /// Calculates bitwise 'xor' between two BitSets.
    /// @param value RHS operand.
    /// @return Bitwise 'xor' result.
    ASPOSECPP_SHARED_API BitArrayPtr Xor(const BitArrayPtr& value);
    /// Negates BitSet.
