...
/// @tparam T Type being compared.
template<class T>
struct ASPOSECPP_SHARED_CLASS EqualityComparerAdapter
{
...
struct ASPOSECPP_SHARED_CLASS DictionaryHashSelector
{
    /// Hasher type to use.
...
/// @tparam T Element type.
template <typename T>
struct ASPOSECPP_SHARED_CLASS DictionaryHashSelector<T, typename std::enable_if<System::detail::has_method_gethashcode<T>::value>::type>
{
    /// Hasher type to use.
    struct type
    {
...
/// @tparam T Element type.
template <typename T>
struct ASPOSECPP_SHARED_CLASS DictionaryHashSelector<T, typename std::enable_if<System::detail::has_ref_method_gethashcode<T>::value && !System::detail::has_method_gethashcode<T>::value>::type>
{
    /// Hasher type to use.
    struct type
    {
...
/// @tparam T Element type.
template <typename T>
struct ASPOSECPP_SHARED_CLASS DictionaryHashSelector<T, typename std::enable_if<std::is_enum<T>::value>::type>
{
    /// Hasher type to use.
    struct type
    {
...
/// @tparam Hashed type.
template<typename T>
struct ASPOSECPP_SHARED_CLASS EqualityComparerHashAdapter
{
