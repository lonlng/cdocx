...
struct LiveObjectsStruct
{
    ...
    std::set<const System::Object*> m_reportedLeakages;
    /// Register of objects that can't be collected.
    std::set<const System::Object*> m_uncollectable;
...
bool ASPOSECPP_SHARED_API __buildIsolationIsland(Object *&last, std::map<const Object*, SharedMembersType> &island, int generation);
/// Prints information on isolation island found.
/// @param island Island to report.
void ASPOSECPP_SHARED_API __reportIsolationIsland(const std::map<const Object*, SharedMembersType> &island);
#endif
