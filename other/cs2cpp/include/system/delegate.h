...
namespace System
{
    ...
    private:
        ...
        protected:
            ...
            /// It is no way to compare result of std::bind, so it is always false.
            /// @param other The object to compare with current object
            /// @returns Information on alikeness of between this and @p other invokers.
            bool deep_compare(const BaseInvoker& other) const override
            {
        ...
        protected:
            ...
            /// Performs deep comparison of the current and the specified objects.
            /// It is no way to compare two std::function, so it is always false.
            /// @param other The object to compare with current object
            /// @returns Information on alikeness of between this and @p other invokers.
            bool deep_compare(const BaseInvoker& other) const override
            {
        ...
        struct ClassMemberInvoker : public BaseInvoker
        {
            ...
            /// @param member Pointer to the non-static method to be invoked.
