...
namespace System
{
    ...
    class ASPOSECPP_SHARED_CLASS BoxedEnum : public System::BoxedValue<UT>
    {
        // BoxedEnum now takes TypeInfo from TypeInfo. It is required that BoxedEnum<T> and EnumValues<T> use the same.
        /// TypeInfo structure describing current class.
        typedef TypeInfo::BoxedValue<E> ThisTypeInfo;

        RTTI_INFO_CUSTOM(System::BoxedEnum<E>, System::BaseTypesInfo<System::BoxedValue<UT>>);
