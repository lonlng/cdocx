...
public:
    ...
    {
        return GetByteCount(static_cast<System::Details::ArrayView<char_t>>(chars), index, count);
    }
    ...
    {
        return GetBytes(static_cast<System::Details::ArrayView<char_t>>(chars), char_index, char_count, static_cast<System::Details::ArrayView<uint8_t>>(bytes), byte_index);
    }
    ...
    {
        return GetBytes(static_cast<System::Details::ArrayView<char_t>>(chars), index, count);
    }
    ...
    {
        return GetString(static_cast<System::Details::ArrayView<uint8_t>>(bytes));
    }
    ...
    {
        return GetString(static_cast<System::Details::ArrayView<uint8_t>>(bytes), index, count);
    }
