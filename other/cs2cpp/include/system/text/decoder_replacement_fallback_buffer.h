...
public:
    ...
    ASPOSECPP_SHARED_API DecoderReplacementFallbackBuffer(const DecoderReplacementFallbackPtr& fallback);
    ...
    virtual ASPOSECPP_SHARED_API int get_Remaining() const override;
