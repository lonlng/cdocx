...
namespace System { namespace IO {
    ...
    public:
        ...
        ASPOSECPP_SHARED_API BinaryWriter(const StreamPtr& stream, const EncodingPtr& encoding = System::Text::Encoding::get_UTF8Unmarked(), bool leaveopen = false);
        /// Destructor.
        ...
        /// @param value The value to write
        virtual ASPOSECPP_SHARED_API void Write(char16_t value);
        ...
        /// @param value The value to write
        virtual ASPOSECPP_SHARED_API void Write(const Decimal& value);
    ...
    protected:
        ...
        /// @param value The value to write
        ASPOSECPP_SHARED_API void Write7BitEncodedInt(int value);
