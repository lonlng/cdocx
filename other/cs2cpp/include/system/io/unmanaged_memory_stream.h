...
public:
    ...
    /// NOT IMPLEMENTED.
    ASPOSECPP_SHARED_API uint8_t* get_PositionPointer();
    /// NOT IMPLEMENTED.
    ASPOSECPP_SHARED_API void set_PositionPointer(uint8_t* value);
    ...
    ASPOSECPP_SHARED_API UnmanagedMemoryStream(uint8_t* pointer, int64_t length);
    /// Constructs a new instance of UnmanagedMemoryStream.
    /// @param pointer A pointer to unmanaged buffer
    /// @param length The size of unmanaged buffer in bytes
    ...
    ASPOSECPP_SHARED_API UnmanagedMemoryStream(uint8_t* pointer, int64_t length, int64_t capacity, FileAccess access);
...
protected:
    ...
    bool _isOpen;
    /// NOT IMPLEMENTED.
    ASPOSECPP_SHARED_API uint8_t* get_Pointer();
    ...
    ASPOSECPP_SHARED_API UnmanagedMemoryStream(uint8_t* pointer, int64_t length, int64_t capacity, FileAccess access, bool skipSecurityCheck);
    ...
    /// @param capacity The total amount of memory assigned to the stream
    /// @param access Specifies if the stream should be read-only, write-onle or both
    ASPOSECPP_SHARED_API void Initialize(uint8_t* pointer, int64_t length, int64_t capacity, FileAccess access);
    /// Initializes a newly created instance of UnmanagedMemoryStream class.
    /// @param pointer A pointer to unmanaged buffer
    /// @param length The size of unmanaged buffer in bytes
    /// @param capacity The total amount of memory assigned to the stream
    /// @param access Specifies if the stream should be read-only, write-onle or both
    /// @param skipSecurityCheck IGNORED
    ASPOSECPP_SHARED_API void Initialize(uint8_t* pointer, int64_t length, int64_t capacity, FileAccess access, bool skipSecurityCheck);
    ...
    /// @param dest A byte array view to copy to
    ...
    static ASPOSECPP_SHARED_API void Memcpy(const System::Details::ArrayView<uint8_t>& dest, int destIndex, uint8_t* src, int srcIndex, int len);
