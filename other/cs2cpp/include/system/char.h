...
public:
    ...
    /// @param str The string containing a char.
    ...
    /// @throw ArgumentNullException If specified string is nullptr.
    /// @throw ArgumentOutOfRangeException If specified index is less than zero or greater than last position in string.
    ...
    {
        return ToUpper(c, Globalization::CultureInfo::get_CurrentCulture());
    }
    ...
    {
        return ToLower(c, Globalization::CultureInfo::get_CurrentCulture());
    }
    ...
    static char_t ToUpper(char_t c, const SharedPtr<Globalization::CultureInfo>& culture)
    {
        if (culture == nullptr)
        {
            throw ArgumentNullException(u"culture");
        }
    ...
    {
        return ToUpper(c, Globalization::CultureInfo::get_InvariantCulture());
    }
    ...
    {
        return ToLower(c, Globalization::CultureInfo::get_InvariantCulture());
    }
    ...
    /// at a specified position in a string into UTF-32 code unit.
    /// @param s  A string that contains a character or surrogate pair
    /// @param index The index position of the character or surrogate pair in specified string
    /// @returns A UTF-32 code unit resulting from conversion
    static ASPOSECPP_SHARED_API int ConvertToUtf32(const String& s, int index);
