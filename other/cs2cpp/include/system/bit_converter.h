...
namespace System {
    ...
    private:
        ...
        /// @param src The byte array view from which the elements are read
        /// @param startIndex The index from which reading from the array begins
        static void UShortFromBytes(uint8_t* dst, const System::Details::ArrayView<uint8_t>& src, int startIndex);
        ...
        /// @param src The byte array view from which the elements are read
        /// @param startIndex The index from which reading from the array begins
        static void UIntFromBytes(uint8_t *dst, const System::Details::ArrayView<uint8_t>& src, int startIndex);
        ...
        /// @param src The byte array view from which the elements are read
        /// @param startIndex The index from which reading from the array begins
        static void ULongFromBytes(uint8_t *dst, const System::Details::ArrayView<uint8_t>& src, int startIndex);
    ...
    public:
        ...
        /// Converts one byte from the specified array starting at the specified index to boolean value
        /// @param value ArrayView that contains bytes to convert
        /// @param startIndex Index in the array at which to start taking bytes for conversion
        /// @returns Boolean value resulting from conversion
