...
#define DECLARE_ENUM_OPERATORS(E) \
    template<class T>\
    inline constexpr typename std::enable_if<std::is_integral<T>::value || std::is_enum<T>::value, E>::type operator|(E a, T b)\
    {\
...
\
    template<class T>\
    inline constexpr typename std::enable_if<std::is_integral<T>::value || std::is_enum<T>::value, bool>::type operator!=(E a, T b)\
    {\
...
\
    template<class T>\
    inline typename std::enable_if<std::is_integral<T>::value || std::is_enum<T>::value, E&>::type operator|=(E& a, T b)\
    {\
...
#define DECLARE_FRIEND_ENUM_OPERATORS(E) \
    template<class T> friend inline constexpr typename std::enable_if<std::is_integral<T>::value || std::is_enum<T>::value, E>::type operator|(E a, T b);\
    template<class T> friend inline constexpr typename std::enable_if<std::is_integral<T>::value || std::is_enum<T>::value, E>::type operator&(E a, T b);\
    template<class T> friend inline constexpr typename std::enable_if<std::is_integral<T>::value || std::is_enum<T>::value, E>::type operator^(E a, T b);\
    template<class T> friend inline constexpr typename std::enable_if<std::is_integral<T>::value || std::is_enum<T>::value, bool>::type operator!=(E a, T b);\
    template<class T> friend inline constexpr typename std::enable_if<std::is_integral<T>::value || std::is_enum<T>::value, bool>::type operator==(E a, T b);\
    friend inline constexpr E operator~(E a);\
    template<class T> friend inline typename std::enable_if<std::is_integral<T>::value || std::is_enum<T>::value, E&>::type operator|=(E& a, T b);\
    template<class T> friend inline typename std::enable_if<std::is_integral<T>::value || std::is_enum<T>::value, E&>::type operator&=(E& a, T b);\
    template<class T> friend inline typename std::enable_if<std::is_integral<T>::value || std::is_enum<T>::value, E&>::type operator^=(E& a, T b);\
    template<class T> friend inline constexpr typename std::enable_if<std::is_integral<T>::value || std::is_enum<T>::value, E>::type operator-(E a, T b);\
    template<class T> friend inline typename std::enable_if<std::is_integral<T>::value || std::is_enum<T>::value, E&>::type operator-=(E& a, T b);\
...
/// Introduces dummy operator in global namespace; it allows 'using \::operator' directives generated by translator compile even if no meaningful implementation exists.
