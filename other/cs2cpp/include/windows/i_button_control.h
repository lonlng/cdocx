...
/// Dummy class to make translated code that uses IButtonControl interface compilable.
...
{
    /// RTTI information.
    RTTI_INFO(System::Windows::Forms::IButtonControl, ::System::BaseTypesInfo<System::Object>);
