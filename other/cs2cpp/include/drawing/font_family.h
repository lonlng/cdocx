...
public:
    ...
    ASPOSECPP_SHARED_API SharedPtr<FontFamily> Clone();
    /// @cond
    // method to pass configuration to Skia
    static ASPOSECPP_SHARED_API void MarkFontFamilyAsSymbolic(const String& name);
    /// @endcond
...
private:
    ...
    /// @param font_family_name A font family name whose style to return
    ...
    /// @param new_font_family_name An output argument; contains the font family name without style at the end
    /// @param prefix Already extracted part of font family style
