...
public:
    ...
    /// Constructs a new instance of LinearGradientBrush.
    /// @param rect A bounding rectangle of the gradient
    /// @param color1 The start color of the gradient
    /// @param color2 The end color of the gradient
    ...
    /// @param isAngleScaleable Specifies if the angle of the gradient is affected by the transformation associated with the brush
...
private:
    /// Represents a basic parameters of a LinearGradientBrush brush.
    typedef std::tuple<Detail::SkPointsHolder, RectangleF, float, bool> GradientInnerData;
    ...
    /// Converts the specified parameters of the brush into GradientInnerData object.
    /// @param point1 The start point of the gradient
    /// @param point2 The end point of the gradient
    ...
    /// @param angle The angle of the gradient orientation line; measured in degrees clockwise from the x-axis
    /// @param isAngleScaleable Specifies if the angle of the gradient is affected by the transformation associated with the brush
    static GradientInnerData CalculateInnerData(const RectangleF& rect, float angle, bool isAngleScaleable);
    ...
    void SetupInitialMatrix(bool isAngleScaleable);
