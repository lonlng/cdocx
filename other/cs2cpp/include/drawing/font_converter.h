...
private:
    ...
    /// @param style Output argument; contains FontStyle value that represents a font style whose name is specified in @p text
    ...
    /// @param unit Output argument; contains GraphicsUnit value that corresponds to @p text
