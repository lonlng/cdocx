...
public:
    ...
    ASPOSECPP_SHARED_API System::Collections::Generic::List<SecurityElement> get_Children();
    /// Sets tag child objects.
    /// @param value List of child elements.
    ASPOSECPP_SHARED_API void set_Children(System::Collections::Generic::List<SecurityElement> value);
    /// Gets tag name.
    /// @return Tag name.
