...
class ASPOSE_WORDS_SHARED_CLASS Forms2OleControlCollection : public System::Collections::Generic::IEnumerable<System::SharedPtr<Aspose::Words::Drawing::Ole::Forms2OleControl>>
{
    typedef Forms2OleControlCollection ThisType;
    typedef System::Collections::Generic::IEnumerable<System::SharedPtr<Aspose::Words::Drawing::Ole::Forms2OleControl>> BaseType;
...
public:
    ...
    using iterator_holder_type = System::Collections::Generic::List<System::SharedPtr<Aspose::Words::Drawing::Ole::Forms2OleControl>>;
...
public:
    ...
    /// Gets enumerator.
    ASPOSE_WORDS_SHARED_API System::SharedPtr<System::Collections::Generic::IEnumerator<System::SharedPtr<Aspose::Words::Drawing::Ole::Forms2OleControl>>> GetEnumerator() override;

    /// Gets <see cref="Aspose::Words::Drawing::Ole::Forms2OleControl">Forms2OleControl</see> object at a specified index.
...
protected:
    ...
    virtual ASPOSE_WORDS_SHARED_API ~Forms2OleControlCollection();
