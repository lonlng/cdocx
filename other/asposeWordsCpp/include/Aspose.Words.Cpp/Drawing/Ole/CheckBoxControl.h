...
//////////////////////////////////////////////////////////////////////////
/// \file Aspose.Words.Cpp/Drawing/Ole/CheckBoxControl.h
#pragma once
...
class ASPOSE_WORDS_SHARED_CLASS CheckBoxControl : public Aspose::Words::Drawing::Ole::MorphDataControl
{
    typedef CheckBoxControl ThisType;
...
public:
    ...
    /// Gets a boolean value indicating either this <see cref="Aspose::Words::Drawing::Ole::CheckBoxControl">CheckBoxControl</see> is checked or not.
    /// The default value is <c>%false</c>.
    ASPOSE_WORDS_SHARED_API bool get_Checked();
    /// Sets a boolean value indicating either this <see cref="Aspose::Words::Drawing::Ole::CheckBoxControl">CheckBoxControl</see> is checked or not.
    /// The default value is <c>%false</c>.
