...
//////////////////////////////////////////////////////////////////////////
/// \file Aspose.Words.Cpp/Drawing/Charts/ChartYValueCollection.h
#pragma once
...
/// 
/// All items of the collection other than <b>%null</b> must have the same <see cref="Aspose::Words::Drawing::Charts::ChartYValue::get_ValueType">ValueType</see>.
/// 
...
class ASPOSE_WORDS_SHARED_CLASS ChartYValueCollection : public System::Collections::Generic::IEnumerable<System::SharedPtr<Aspose::Words::Drawing::Charts::ChartYValue>>
{
    typedef ChartYValueCollection ThisType;
    typedef System::Collections::Generic::IEnumerable<System::SharedPtr<Aspose::Words::Drawing::Charts::ChartYValue>> BaseType;
...
public:
    ...
    /// Setter for Aspose::Words::Drawing::Charts::ChartYValueCollection::get_FormatCode
    ASPOSE_WORDS_SHARED_API void set_FormatCode(const System::String& value);

    /// Returns an enumerator object.
    ASPOSE_WORDS_SHARED_API System::SharedPtr<System::Collections::Generic::IEnumerator<System::SharedPtr<Aspose::Words::Drawing::Charts::ChartYValue>>> GetEnumerator() override;

    /// Gets or sets the Y value at the specified index.
    ASPOSE_WORDS_SHARED_API System::SharedPtr<Aspose::Words::Drawing::Charts::ChartYValue> idx_get(int32_t index);
    /// Gets or sets the Y value at the specified index.
    ASPOSE_WORDS_SHARED_API void idx_set(int32_t index, const System::SharedPtr<Aspose::Words::Drawing::Charts::ChartYValue>& value);

protected:

    virtual ASPOSE_WORDS_SHARED_API ~ChartYValueCollection();
