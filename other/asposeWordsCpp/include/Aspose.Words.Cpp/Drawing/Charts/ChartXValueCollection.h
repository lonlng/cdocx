...
//////////////////////////////////////////////////////////////////////////
/// \file Aspose.Words.Cpp/Drawing/Charts/ChartXValueCollection.h
#pragma once
...
/// 
/// All items of the collection other than <b>%null</b> must have the same <see cref="Aspose::Words::Drawing::Charts::ChartXValue::get_ValueType">ValueType</see>.
/// 
/// The collection allows only changing X values. To add or insert new values to a chart series, or remove values,
/// the appropriate methods of the <see cref="Aspose::Words::Drawing::Charts::ChartSeries">ChartSeries</see> class can be used.
/// 
...
class ASPOSE_WORDS_SHARED_CLASS ChartXValueCollection : public System::Collections::Generic::IEnumerable<System::SharedPtr<Aspose::Words::Drawing::Charts::ChartXValue>>
{
    typedef ChartXValueCollection ThisType;
    typedef System::Collections::Generic::IEnumerable<System::SharedPtr<Aspose::Words::Drawing::Charts::ChartXValue>> BaseType;
...
public:
    ...
    /// Setter for Aspose::Words::Drawing::Charts::ChartXValueCollection::get_FormatCode
    ASPOSE_WORDS_SHARED_API void set_FormatCode(const System::String& value);

    /// Returns an enumerator object.
    ASPOSE_WORDS_SHARED_API System::SharedPtr<System::Collections::Generic::IEnumerator<System::SharedPtr<Aspose::Words::Drawing::Charts::ChartXValue>>> GetEnumerator() override;

    /// Gets or sets the X value at the specified index.
    ASPOSE_WORDS_SHARED_API System::SharedPtr<Aspose::Words::Drawing::Charts::ChartXValue> idx_get(int32_t index);
    /// Gets or sets the X value at the specified index.
    ASPOSE_WORDS_SHARED_API void idx_set(int32_t index, const System::SharedPtr<Aspose::Words::Drawing::Charts::ChartXValue>& value);

protected:

    virtual ASPOSE_WORDS_SHARED_API ~ChartXValueCollection();
