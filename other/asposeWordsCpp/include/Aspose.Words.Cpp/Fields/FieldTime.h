...
//////////////////////////////////////////////////////////////////////////
/// \file Aspose.Words.Cpp/Fields/FieldTime.h
#pragma once
...
class ASPOSE_WORDS_SHARED_CLASS FieldTime : public Aspose::Words::Fields::Field
{
    typedef FieldTime ThisType;
...
protected:
    ...
    virtual ASPOSE_WORDS_SHARED_API ~FieldTime();
