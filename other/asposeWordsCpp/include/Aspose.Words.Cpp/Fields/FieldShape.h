...
//////////////////////////////////////////////////////////////////////////
/// \file Aspose.Words.Cpp/Fields/FieldShape.h
#pragma once
...
class ASPOSE_WORDS_SHARED_CLASS FieldShape : public Aspose::Words::Fields::Field
{
    typedef FieldShape ThisType;
...
protected:
    ...
    virtual ASPOSE_WORDS_SHARED_API ~FieldShape();
