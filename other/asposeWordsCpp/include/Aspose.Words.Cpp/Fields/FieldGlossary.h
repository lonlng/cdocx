...
//////////////////////////////////////////////////////////////////////////
/// \file Aspose.Words.Cpp/Fields/FieldGlossary.h
#pragma once
...
class ASPOSE_WORDS_SHARED_CLASS FieldGlossary : public Aspose::Words::Fields::Field, public Aspose::Words::Fields::IFieldAutoTextCode
{
    typedef FieldGlossary ThisType;
...
protected:
    ...
    virtual ASPOSE_WORDS_SHARED_API ~FieldGlossary();
