...
//////////////////////////////////////////////////////////////////////////
/// \file Aspose.Words.Cpp/Fields/FieldFormDropDown.h
#pragma once
...
class ASPOSE_WORDS_SHARED_CLASS FieldFormDropDown : public Aspose::Words::Fields::Field
{
    typedef FieldFormDropDown ThisType;
...
protected:
    ...
    virtual ASPOSE_WORDS_SHARED_API ~FieldFormDropDown();
