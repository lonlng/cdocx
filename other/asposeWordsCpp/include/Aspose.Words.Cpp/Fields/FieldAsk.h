...
//////////////////////////////////////////////////////////////////////////
/// \file Aspose.Words.Cpp/Fields/FieldAsk.h
#pragma once
...
class ASPOSE_WORDS_SHARED_CLASS FieldAsk : public Aspose::Words::Fields::Field, public Aspose::Words::Fields::IFieldCodeTokenInfoProvider
{
    typedef FieldAsk ThisType;
...
protected:
    ...
    virtual ASPOSE_WORDS_SHARED_API ~FieldAsk();
