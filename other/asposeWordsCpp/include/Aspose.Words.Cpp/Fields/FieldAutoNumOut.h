...
//////////////////////////////////////////////////////////////////////////
/// \file Aspose.Words.Cpp/Fields/FieldAutoNumOut.h
#pragma once
...
class ASPOSE_WORDS_SHARED_CLASS FieldAutoNumOut : public Aspose::Words::Fields::Field
{
    typedef FieldAutoNumOut ThisType;
...
protected:
    ...
    virtual ASPOSE_WORDS_SHARED_API ~FieldAutoNumOut();
