...
public:
    ...
    /// Gets font color. The default value is <see cref="System::Drawing::Color::get_Silver">Silver</see>.
    ASPOSE_WORDS_SHARED_API System::Drawing::Color get_Color() const;
    /// Sets font color. The default value is <see cref="System::Drawing::Color::get_Silver">Silver</see>.
