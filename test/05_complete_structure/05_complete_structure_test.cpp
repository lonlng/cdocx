...
TEST(CompleteStructureTest, LoadCompleteStructure) {
    ...
    if (!doc.is_open()) {
        std::cout << "  SKIPPED: Could not open template.docx" << std::endl;
        return;
    }
...
TEST(CompleteStructureTest, SaveCompleteStructure) {
...
TEST(CompleteStructureTest, MediaManagement) {
...
TEST(CompleteStructureTest, XmlModification) {
